...
void read_data(string path, string delimiter, int stepSize, vector<timeEdge>& edges, vector<int>& snapshots, int& n, int& m, int& timeNum, vector<int>& labels)
{
    vector<int> nodes;
    vector<int> times;
